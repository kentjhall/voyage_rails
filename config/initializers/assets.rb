...
Rails.application.config.assets.precompile += %w( flowers_animation.js )
...
Rails.application.config.assets.precompile += %w( mobile_application.scss )
...
Rails.application.config.assets.precompile += %w( charges.scss )
